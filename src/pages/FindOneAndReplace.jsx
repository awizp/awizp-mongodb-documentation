        ...
        <section className="w-full py-10">
            <div className="custom-container space-y-5">
                <div className="w-full">
                    <h2 className="mb-5 text-green-800 font-semibold text-2xl">findOneAndReplace()</h2>

                    <p className="pl-5">This command used to replace the whole document with the new one.</p>
                </div>
    ...
    [
        ...
        { _id: 5, name: "Eshwar Rao", age: 20, grade: "B", subjects: ["Physics", "Chemistry"], gpa: 3.4, lastUpdated: ISODate("2025-02-15"), status: "active", address: { city: "Visakhapatnam", state: "Andhra Pradesh" } }
                ...
                <div className="w-full">
                    ...
                    <p className="pl-5">We have to find first id and replace with the new one.</p>

                    <pre className="code-block mb-5 custom-scroll">
                        <code> {`
    db.students.findOneAndReplace(
        { _id: 4 },
        { name: "Priya", age: 22, grade: "B", subjects: ["Chemistry", "Biology"] },
